% to test why the single neuron performances have now a few percentage
% points above the chance level.
% to this aim, I'm going to run the exact same code that generates the
% raised offset, but with no bootstrapping/permutation.
% I also do it specifically for the o2o scenario.
%
% Dec 28, 2022
...
% save results
save('test_xx_108_4_single_o2o_perf.mat', 'verif');
