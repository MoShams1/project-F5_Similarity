...
% this script is to produce the population performance (fig.3B)
% i attempt here to add a bootstrap to later calculate the confidence
% interval for the outcome perfomance
% this is the exe2obs part (the 1st leg of two)
% 2022-05-4
...
save('xx_109_7_pop_exe2obs.mat', 'perf');
